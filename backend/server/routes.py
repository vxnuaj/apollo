...
@router.post("/chat/completions") # TODO - fix, currently is deprecated. this should, given a request, get teh message history and etc, to tokenize and then send to the gpu endpoint for generation
...
async def stream_completion(
    ...
    # TODO - stream token rsponse from inferenc ser ver using a websocket   
    
    
# ----- NOTE - the below is deprecated 
...
async def health_check():
    ...
    return HealthCheck(
        status="healthy" if db_status == "connected" and tokenizer_loaded else "degraded",
        database=db_status,
